      ...
      items: [
        {
          ...
          title: "Mon profil",
          color: "#00A8E8",
          subtitle: "Yohann • yohann@email.com",
        },
        {
      ...
      <View style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <View style={styles.avatarSection}>
            ...
            <Text style={styles.userName}>Yohann</Text>
            <Text style={styles.userEmail}>yohann@gmail.com</Text>
          </View>
        </View>
      </View>
      ...
      >
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => router.push("/order/orders")}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.settingsContent}>
            ...
            <TouchableOpacity style={styles.settingItem} activeOpacity={0.7}>
              <View style={styles.settingLeft}>
                <View
                  style={[styles.settingIcon, { backgroundColor: "#E8F5E8" }]}
                >
                  <Ionicons
